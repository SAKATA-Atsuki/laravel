...
<body>
    ...
    <div class="button-review-complete">
        <a href="{{ route('review.list', ['pg' => $data['page'], 'id' => $data['id']]) }}" class="button-review-complete-1">商品レビュー一覧へ</a>
        <div style="height: 50px;"></div>
        <a href="{{ route('product.detail', ['page' => $data['page'], 'id' => $data['id']]) }}" class="button-review-complete-2">商品詳細に戻る</a>
    </div>
</body>
</html>