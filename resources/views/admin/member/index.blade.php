    ...
    <div class="admin-member-main">
        <form action="{{ route('admin.member') }}" method="POST">
            ...
            <div class="admin-member-main-join">
                <a href="{{ route('admin.member.register') }}" class="admin-member-main-join-button">会員登録</a>
            </div>
            ...
            <div class="admin-member-main-result">
                ...
                @foreach ($members as $member)
                    <div class="admin-member-main-result-main">
                        ...
                        <a href="{{ route('admin.member.detail', ['id' => $member->id]) }}" class="admin-member-main-result-main-name">{{ $member->name_sei }}　{{ $member->name_mei }}</a>
                        ...
                        <a href="{{ route('admin.member.edit', ['id' => $member->id]) }}" class="admin-member-main-result-main-edit">編集</a>
                        <a href="{{ route('admin.member.detail', ['id' => $member->id]) }}" class="admin-member-main-result-main-detail">詳細</a>
                    </div>
                @endforeach
