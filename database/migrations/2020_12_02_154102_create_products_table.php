...
class CreateProductsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('products', function (Blueprint $table) {
            ...
            $table->string('image_1', 255)->nullable($value = true)->comment('写真１');
            $table->string('image_2', 255)->nullable($value = true)->comment('写真２');
            $table->string('image_3', 255)->nullable($value = true)->comment('写真３');
            $table->string('image_4', 255)->nullable($value = true)->comment('写真４');
