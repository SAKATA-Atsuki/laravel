...
<body>
    <div id="top-head-2">
        <span class="product-list-title">商品レビュー編集確認</span>
        <div>
    ...
    <div class="review-register">
        ...
        <form action="<?php echo e(route('mypage.review.store')); ?>" method="POST">
            <div class="review-check-button">
                ...
                <input type="hidden" name="review_id" value="<?php echo e($data['review_id']); ?>">
                ...
                <input type="submit" value="更新する" class="button-review-check-1">
                <br>
...
</html><?php /**PATH /Applications/MAMP/htdocs/laravelbbs/resources/views/mypage/review/check.blade.php ENDPATH**/ ?>